...
public class Service : IService
{
  public async Task SendVerificationEmailAsync(User user, CancellationToken cancellationToken)
  {
    ...
    var from = new EmailAddress(Configurations.Email.DefaultFromEmail, Configurations.Email.DefaultFromName);
    const string subject = "Verfique sua conta.";
    var to = new EmailAddress(user.Email, user.Name);
    var content = $"Código {user.Email.Verifier.Code}";
